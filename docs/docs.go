        ...
        "/dashboard/table": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Limite de registros (default 20, max 100)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.DashboardTableResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.VigiaTurnoResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
    ...
    "definitions": {
        ...
        "model.DashboardTableResponse": {
            ...
            "properties": {
                ...
                "linhas": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.DashboardLinha"
                    }
                },
                "offset": {
                    "type": "integer",
        ...
        "model.VigiaTurnoResponse": {
            ...
            "properties": {
                ...
                "proximo_turno": {
                    "$ref": "#/definitions/model.VigiaProximoTurno"
                },
                "tem_turno_ativo": {
                    "type": "boolean"
                },
                "turno": {
                    "$ref": "#/definitions/model.VigiaTurnoInfo"
                }
            }
        }
    },
