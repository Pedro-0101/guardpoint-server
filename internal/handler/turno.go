...
// @Tags         turnos
// @Param        status query string false "Status (agendado,em_andamento,pausado,critico,finalizado,atrasado,nao_realizado) - multiplos separados por virgula"
...
// @Success      200 {object} model.TurnoListResponse
// @Failure      500 {object} model.ErrorResponse
// @Router       /turnos [get]
...
// @Success      200 {object} model.LoteCheckinResponse
// @Failure      400 {object} model.ErrorResponse
// @Failure      500 {object} model.ErrorResponse
